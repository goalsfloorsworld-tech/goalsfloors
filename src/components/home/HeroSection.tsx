...
export default function HeroSection() {
  ...
  return (
    <section suppressHydrationWarning className="relative flex items-center overflow-hidden w-full max-w-full box-border bg-[#f6f2ea] dark:bg-[#0F172A] transition-colors duration-300">
      ...
      {/* Content Layer */}
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-[355px] sm:pt-[330px] md:pt-[500px] lg:pt-16 pb-4 md:pb-24 lg:pb-[176px] flex flex-col lg:flex-row items-center gap-2 lg:gap-4 h-full">
