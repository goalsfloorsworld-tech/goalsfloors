...
export default function AllProductsPage() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-slate-950 min-h-screen pb-24 transition-colors duration-300">
      ...
      <div className="bg-gray-950 dark:bg-black py-16 md:py-24 border-b border-amber-600">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
          <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400 font-semibold uppercase tracking-widest text-sm">
              ...
              <button
                ...
                className={`px-6 py-2 text-sm font-semibold uppercase tracking-widest transition-all rounded-none border ${
                  activeCategory === category
                    ...
                    : "bg-white dark:bg-slate-900 border-gray-200 dark:border-gray-800 text-gray-600 dark:text-gray-300 hover:border-amber-500 dark:hover:border-amber-500 hover:text-amber-600 dark:hover:text-amber-500"
                }`}
              >
                {category}
              </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProducts.map((product) => (
            <Link 
              ...
              key={product.slug}
              className="group bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 shadow-sm dark:shadow-none hover:shadow-2xl hover:border-amber-200 dark:hover:border-amber-600 transition-all duration-500 flex flex-col h-full"
            >
              {/* Product Image */}
              <div className="relative h-64 w-full overflow-hidden bg-gray-100 dark:bg-slate-800">
                ...
                <div className="absolute top-4 left-4 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm px-3 py-1 text-xs font-bold uppercase tracking-widest text-amber-700 dark:text-amber-500">
                  {product.category}
                </div>
              </div>
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="flex items-center justify-between border-t border-gray-100 dark:border-gray-800 pt-4 mt-auto">
                  ...
                  <div className="w-8 h-8 rounded-full bg-gray-50 dark:bg-slate-800 flex items-center justify-center group-hover:bg-amber-600 group-hover:text-white transition-colors text-gray-400 dark:text-gray-300">
