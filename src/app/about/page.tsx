    ...
    <main className="min-h-screen pt-24 bg-white dark:bg-slate-950 transition-colors duration-300">
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="text-center p-8 bg-gray-50 dark:bg-slate-900 border border-gray-100 dark:border-gray-800 rounded-sm hover:shadow-xl dark:shadow-none transition-all">
            <div className="inline-flex w-16 h-16 bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-500 rounded-full items-center justify-center mb-6">
              <Trophy className="w-8 h-8" />
            </div>
            <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">19+ Years Experience</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">Two decades of mastering the art of flooring and paneling for premium Indian homes and commercial spaces.</p>
          </div>
          ...
          <div className="text-center p-8 bg-gray-50 dark:bg-slate-900 border border-gray-100 dark:border-gray-800 rounded-sm hover:shadow-xl dark:shadow-none transition-all">
            ...
            <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Certified Quality</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">Every product comes with official warranties, being termite-proof, water-resistant, and fire-retardant.</p>
          </div>
          ...
          <div className="text-center p-8 bg-gray-50 dark:bg-slate-900 border border-gray-100 dark:border-gray-800 rounded-sm hover:shadow-xl dark:shadow-none transition-all">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">Trusted by 10,000+ happy clients and major developers across NCR for our transparent pricing and support.</p>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="text-xs uppercase tracking-widest text-gray-500 dark:text-gray-400">Delivery in NCR</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-amber-600 mb-1">10k+</div>
                  <div className="text-xs uppercase tracking-widest text-gray-500 dark:text-gray-400">Happy Clients</div>
                </div>
              </div>
            </div>
          </div>
